...
const BookingForm = () => {
  ...
  const removeStaySpot = (tripIndex, vehicleIndex, staySpotIndex) => {
    setFormData((prev) => {
      ...
      if (newVehicles[tripIndex][vehicleIndex].staySpots.length > 1) {
        newVehicles[tripIndex][vehicleIndex] = {
          ...newVehicles[tripIndex][vehicleIndex],
          staySpots: newVehicles[tripIndex][vehicleIndex].staySpots.filter(
            (_, i) => i !== staySpotIndex
          ),
        };
      }
  ...
  const handleServiceTypeChange = (service) => {
    ...
    setFormData((prev) => {
      const newVehicles = ["City Transfer", "Airport Transfer"].includes(
        service
      )
        ? [
        ...
        ? Array.from(
            {
              length:
                prev.rentalDaysOption === "multiple"
                  ? prev.rentalDaysCount || 1
                  : 1,
            },
            () =>
              Array.from({ length: prev.numOfVehicles[0] || 1 }, () => ({
  ...
  const handleNumOfVehiclesChange = (tripIndex, value) => {
    ...
    setFormData((prev) => {
      ...
      const newVehicles = [...prev.vehicles];
      newVehicles[tripIndex] = Array.from(
        { length: count || 1 },
        (_, index) =>
      ...
      return {
        ...prev,
        numOfVehicles: newNumOfVehicles,
        vehicles: newVehicles,
      };
    });
    setSelectedVehicleTypes((prev) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const bookingData = {
      ...
      dropoffLocations: formData.vehicles.flat().map((vehicle) => ({
      ...
      rentalDays:
        formData.rentalDaysOption === "multiple" ? formData.rentalDaysCount : 1,
      flightNumber:
        formData.serviceType === "Airport Transfer"
  ...
  const isTransferService = ["City Transfer", "Airport Transfer"].includes(
          ...
          <form onSubmit={handleSubmit}>
            <div className="columns-2 grid">
                ...
                <div className="dropdown-container w-full">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="w-full p-2.5 mb-8 sm:p-3 border border-gray-300 rounded-md bg-white text-left flex justify-between items-center hover:border-[#1F5546] focus:outline-none focus:ring-2 focus:ring-[#1F5546] focus:border-transparent transition-colors"
                    >
                      ...
                      <svg
                        className={`w-4 h-4 transition-transform ${
                          dropdownStates.serviceTypes ? "rotate-180" : ""
                        }`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                  ...
                  <div className="dropdown-container w-full">
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <svg
                          className={`w-4 h-4 transition-transform ${
                            dropdownStates.addOnServices ? "rotate-180" : ""
                          }`}
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
              ...
              {isTransferService && (
                <div>
                  <label
                    htmlFor="numOfVehicles"
                    className="block text-sm font-medium text-gray-700 mb-2 sm:mb-2"
                  >
                    Number of Vehicles
                  </label>
                  <input
                    ...
                    onChange={(e) =>
                      handleNumOfVehiclesChange(0, e.target.value)
                    }
                    type="number"
                    min="1"
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        onChange={() => {
                          ...
                          setSelectedVehicleTypes([
                            Array(formData.numOfVehicles[0] || 1).fill(""),
                          ]);
                          setSelectedMakes([
                            Array(formData.numOfVehicles[0] || 1).fill(""),
                          ]);
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        onChange={() => {
                          ...
                          setSelectedVehicleTypes(
                            Array(formData.rentalDaysCount || 1)
                              .fill()
                              .map(() => Array(1).fill(""))
                          );
                          setSelectedMakes(
                          ...
                          setFormData((prev) => ({
                            ...
                            vehicles: Array.from(
                              ...
                              (_, index) =>
                                prev.vehicles[index] ||
                                Array.from(
                                  { length: prev.numOfVehicles[index] || 1 },
                                  () => ({
                                    pickupLocation: "",
                                    pickupLatitude: null,
                                    pickupLongitude: null,
              ...
              {(isTransferService || isHireService) && (
                <div className="flex flex-col space-y-2">
                  {formData.vehicles.map((tripVehicles, tripIndex) => (
                    <div key={tripIndex} className="p-2">
                        ...
                        <div className="mb-4 flex flex-col md:flex-row md:items-center md:space-x-4">
                          <div className="flex-1 mb-2 md:mb-0">
                            ...
                            <input
                              ...
                              min="1"
                              placeholder="Enter number of vehicles"
                              className="w-full p-2.5 sm:p-3  text-gray-500 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1F5546] focus:border-transparent text-sm sm:text-base"
                            />
                          </div>
                        </div>
                      )}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div className="relative">
                                ...
                                <input
                                  ...
                                  onFocus={() =>
                                    setActiveField(
                                      `dropoff-${tripIndex}-${vehicleIndex}`
                                    )
                                  }
                                  onBlur={() =>
                                    setTimeout(() => setActiveField(null), 200)
                              ...
                              <div>
                                <div className="flex items-center justify-between mb-2">
                                  ...
                                  <button
                                    type="button"
                                    onClick={() =>
                                      addStaySpot(tripIndex, vehicleIndex)
                                    }
                                ...
                                {vehicle.staySpots.map(
                                  (staySpot, staySpotIndex) => (
                                    <div
                                      key={staySpotIndex}
                                    ...
                                    >
                                      ...
                                      <input
                                        ...
                                        onFocus={() =>
                                          setActiveField(
                                            `staySpots-${tripIndex}-${vehicleIndex}-${staySpotIndex}`
                                          )
                                        }
                                        onBlur={() =>
                                          setTimeout(
                            ...
                            <div className="">
                              ...
                              <div className="flex flex-col md:flex-row gap-4 w-full">
                                <div className="dropdown-container relative w-full ">
                                  <select
                                    value={
                                      selectedVehicleTypes[tripIndex]?.[
                                        vehicleIndex
                                      ] || ""
                                    }
                                    onChange={(e) =>
